...
// FIX: Refactored to use composition over inheritance for EventEmitter to avoid type errors in this environment
export class GenAILiveClient {
  ...
  constructor(apiKey: string, model?: string) {
    // FIX: Removed super() as we no longer extend EventEmitter
